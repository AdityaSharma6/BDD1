...
def secret_key(n_clicks):
    if n_clicks == None:
        ...
        return "Scroll down to retrieve your token. Your token is the series of numbers within the grey box. Please return to the Data Analysis Site and follow Step 2."
